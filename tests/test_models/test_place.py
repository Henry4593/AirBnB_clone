...
class TestPlace_instantiation(unittest.TestCase):
    """Unittests for the Place class's instantiation."""

    def test_no_args_instantiates(self):
        """Tests if Place can be instantiated without arguments."""
    ...
    def test_instantiation_with_kwargs(self):
        ...
        plc = Place(id="345", created_at=dt_isofmt, updated_at=dt_isofmt)
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_output(self):
        ...
        self.assertDictEqual(plc.to_dict(), dt_dict)
