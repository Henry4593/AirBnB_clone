...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        """Tests creating a User instance without arguments."""
        self.assertEqual(User, type(User()))

    def test_new_instance_stored_in_objects(self):
        """Tests if a new User instance is stored in the model storage."""
        self.assertIn(User(), models.storage.all().values())

    def test_id_is_public_str(self):
        """Tests creating a User instance with keyword arguments."""
        self.assertEqual(str, type(User().id))

    def test_created_at_is_public_datetime(self):
        """Tests creating a User with None keyword arguments (raises
        TypeError).
        """
    ...
    def test_args_unused(self):
        """Tests that arguments passed to User constructor are unused."""
        user = User(None)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        user = User(id="345", created_at=dt_isofmt, updated_at=dt_isofmt)
...
class TestUser_save(unittest.TestCase):
    """Unittests for the User class's save method."""
    ...
    def test_one_save(self):
        """Tests if saving a User updates its updated_at timestamp."""
        user = User()
        sleep(0.05)
    ...
    def test_two_saves(self):
        """Tests if saving a User twice updates updated_at multiple times."""
        user = User()
        sleep(0.05)
        first_updated_at = user.updated_at
        user.save()
    ...
    def test_save_updates_file(self):
        """Tests if saving a User writes its information to file.json."""
        user = User()
        user.save()
...
class TestUser_to_dict(unittest.TestCase):
    """Unittests for the User class's to_dict method."""
    ...
    def test_to_dict_output(self):
        ...
        self.assertDictEqual(user.to_dict(), dt_dict)
